...
class ChangePass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xff57676f),
      appBar: AppBar(
        elevation: 0,
        centerTitle: false,
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xff5c6c74),
                      shape: BoxShape.rectangle,
                      borderRadius: BorderRadius.circular(12.0),
                      border: Border.all(color: const Color(0xffd8fbe9), width: 1),
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            decoration: InputDecoration(
                              disabledBorder: OutlineInputBorder(
                                ...
                                borderSide: const BorderSide(
                                    color: Color(0xff454545), width: 1),
                              ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.rectangle,
                      borderRadius: BorderRadius.circular(12.0),
                      border: Border.all(color: const Color(0xffd9fcea), width: 1),
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.rectangle,
                      borderRadius: BorderRadius.circular(12.0),
                      border: Border.all(color: const Color(0xffd8feea), width: 1),
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
